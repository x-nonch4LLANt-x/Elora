...
type LayoutRouteId = RouteId | "/" | "/about" | "/accessories" | "/cart" | "/catalog" | "/checkout" | "/contact" | "/dashboard" | "/products/[id]" | "/reviews/[productId]" | "/settings" | "/settings/orders" | "/settings/profile" | "/wishlist" | null
type LayoutParams = RouteParams & { id?: string; productId?: string }
